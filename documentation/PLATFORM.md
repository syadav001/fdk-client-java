...
* [Content](#Content)
  ...
  * [Content#updatePathRedirectionRules](#contentupdatepathredirectionrules)
  * [Content#getPathRedirectionRules](#contentgetpathredirectionrules)
...
* [Order](#Order)
  ...
  * [Order#ShipmentBagsCanBreak](#ordershipmentbagscanbreak)
...
| priority | Object? | Filter tickets on priority |   
...
| --------- | ----  | --- | 
| companyId | Integer? | Company Id |   
| uniqueExternalId | String? | Unique external id |  
...
| --------- | ----  | --- | 
| companyId | String? | A `company_id` is a unique identifier for a particular seller account. |   
| department | String? | A `department` is the name of a particular department. |  
...
| itemIds | List<Integer>? | Get multiple products filtered by Item Ids |   
...
| tags | List<String>? | Get multiple products filtered by tags |   
| pageNo | Integer? | The page number to navigate through the given set of results |   
| pageSize | Integer? | Number of items to retrieve in each page. Default is 10. |  
...
| itemIds | List<Integer>? | Item Ids of product |  
