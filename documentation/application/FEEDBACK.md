...
| rating | List<Double>? | no | rating filter, e.g. 1-5 |   
| attributeRating | List<String>? | no | Filter for attribute rating. |   
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | avg | Double? |  yes  |  |
 | count | Integer? |  yes  | Valuetype could be average, count |
...
---
 ...
 | ratingCount | Integer? |  yes  | total rating count |
 | ratingMetric | ArrayList<[RatingMetric](#RatingMetric)>? |  yes  |  |
 | reviewCount | Integer? |  yes  | total review count |
