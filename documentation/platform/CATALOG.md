...
```java
client.catalog.getOptimalLocations(body body) {
  //use response
}
```
...
---
 ...
 | operators | HashMap<String,Object> |  no  |  |
...
---
 ...
 | meta | HashMap<String,Object>? |  yes  |  |
 | index | Integer? |  yes  |  |
 | strategyWiseListing | ArrayList<HashMap<String,Object>>? |  yes  |  |
 | quantity | Integer |  no  |  |
 | status | Boolean |  no  |  |
