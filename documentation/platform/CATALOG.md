...
| itemCode | List<Double>? | no | Get multiple products filtered by Item Code |   
...
```java
client.application("<APPLICATION_ID>").catalog.getApplicationBrands( department,  pageNo,  pageSize) {
  //use response
}
```
