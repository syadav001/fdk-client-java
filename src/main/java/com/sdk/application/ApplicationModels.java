...
@Setter
@JsonIgnoreProperties(ignoreUnknown = true)
public static class CartRequestResponse{
...
@Setter
@JsonIgnoreProperties(ignoreUnknown = true)
public static class AddRequestCartResponse{
    ...
    @JsonProperty("cart")
    private CartRequestResponse cart;
...
@Setter
@JsonIgnoreProperties(ignoreUnknown = true)
public static class UpdateRequestCartResponse{
