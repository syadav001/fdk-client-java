...
public static class TicketHistoryList {
    ...
    @JsonProperty("docs")
    private List<TicketHistory> docs;
...
public static class CreateVideoRoomPayload {
    ...
    @JsonProperty("notify")
    private List<HashMap<String,Object>> notify;
...
public static class Preset {
    ...
    @JsonProperty("sections")
    private List<AvailablePageSchema> sections;
...
public static class NavigationReference {
    ...
    private NavigationReference subNavigation;
...
public static class CustomPageSchema {
    ...
    @JsonProperty("content")
    private List<ContentSchema> content;
...
public static class PageMetaSchema {
    ...
    private List<HashMap<String,Object>> systemPages;
    
    
    @JsonProperty("custom_pages")
    private List<HashMap<String,Object>> customPages;
...
@Setter
@JsonIgnoreProperties(ignoreUnknown = true)
public static class CompanyStoreSerializerRequest {
...
@Setter
@JsonIgnoreProperties(ignoreUnknown = true)
public static class BusinessCountryInfo1 {
...
public static class GetCompanyProfileSerializerResponse {
    ...
    @JsonProperty("business_country_info")
    private BusinessCountryInfo1 businessCountryInfo;
