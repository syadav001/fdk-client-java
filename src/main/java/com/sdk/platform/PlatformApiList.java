...
interface LeadApiList {
    ...
    Call<PlatformModels.TicketList> getTickets(@Path("company_id") String companyId , @Query("items") Boolean items , @Query("filters") Boolean filters , @Query("q") String q , @Query("status") String status , @Query("priority") String priority , @Query("category") String category , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize );
    ...
    Call<PlatformModels.TicketList> getTickets(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("items") Boolean items , @Query("filters") Boolean filters , @Query("q") String q , @Query("status") String status , @Query("priority") String priority , @Query("category") String category );
    ...
    Call<PlatformModels.GetTokenForVideoRoomResponse> getASDF(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("in_query") PlatformClient.PriorityEnum inQuery , @Header("in_header") PlatformClient.PriorityEnum inHeader , @Path("in_path") PlatformClient.PriorityEnum inPath );
    
    @GET ("/service/platform/lead/company/{company_id}/asdf/{in_path}/asdf")
    Call<PlatformModels.GetTokenForVideoRoomResponse> getASDF(@Path("company_id") String companyId , @Query("in_query") PlatformClient.PriorityEnum inQuery , @Header("in_header") PlatformClient.PriorityEnum inHeader , @Path("in_path") PlatformClient.PriorityEnum inPath );
...
interface ContentApiList {
    ...
    Call<PlatformModels.TagsSchema> removeInjectableTag(@Path("company_id") String companyId , @Path("application_id") String applicationId ,@Body PlatformModels.RemoveHandpickedSchema payload);
...
interface AssignmentApiList {
    ...
    Call<PlatformModels.Success> createPickupLocation(@Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.PickupPointSchema payload);
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/pickup/locations")
    Call<PlatformModels.PickupPointResponse> getPickupLocation(@Query("q") String q , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @PUT ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/pickup/locations/{id}")
    Call<PlatformModels.Success> updatePickupLocation(@Path("id") Double id , @Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.PickupPointSchema payload);
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/pickup/locations/{id}")
    Call<PlatformModels.PickupPointSchema> getPickupLocationById(@Path("id") Double id , @Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @POST ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/pickup/configurations")
    Call<PlatformModels.Success> createPickupConfiguration(@Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.PickupConfiguration payload);
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/pickup/configurations")
    Call<PlatformModels.PickupResponse> getPickupConfiguration(@Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/allocate/configurations")
    Call<PlatformModels.ShippingResponse> getAllocationConfiguration(@Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @POST ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/allocate/configurations")
    Call<PlatformModels.Success> createAllocationConfiguration(@Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.ShippingSchema payload);
    
    @PUT ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/allocate/configurations")
    Call<PlatformModels.Success> updateAllocationConfiguration(@Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.ShippingSchema payload);
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/allocate/locations/")
    Call<PlatformModels.StoreListResponse> getAllocationLocations(@Query("q") String q , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("type") String type , @Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/allocate/locations/{id}")
    Call<PlatformModels.StoreResponse> getAllocationLocationById(@Path("id") Double id , @Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @PUT ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/allocate/locations/{id}")
    Call<PlatformModels.Success> updateAllocationLocation(@Path("id") Double id , @Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.StoreSchema payload);
    
    @POST ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/allocate/locations")
    Call<PlatformModels.Success> createAllocationLocation(@Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.StoreSchema payload);
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/destination-zones")
    Call<PlatformModels.ZoneListResponse> getDestinationZones(@Query("q") String q , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @POST ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/destination-zones")
    Call<PlatformModels.Success> postDestinationZone(@Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.ZoneSchema payload);
    
    @GET ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/destination-zones/{id}")
    Call<PlatformModels.ZoneSchema> getDestinationZoneById(@Path("id") Double id , @Path("company_id") Integer companyId , @Path("application_id") String applicationId );
    
    @PUT ("/service/platform/assignment/v1.0/company/{company_id}/application/{application_id}/destination-zones/{id}")
    Call<PlatformModels.Success> updateDestinationZone(@Path("id") Double id , @Path("company_id") Integer companyId , @Path("application_id") String applicationId ,@Body PlatformModels.ZoneSchema payload);
...
interface CommunicationApiList {
    ...
    Call<PlatformModels.Campaigns> getCampaigns(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.Audiences> getAudiences(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.EmailProviders> getEmailProviders(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.EmailTemplates> getEmailTemplates(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.SystemEmailTemplates> getSystemEmailTemplates(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.Jobs> getJobs(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.JobLogs> getJobLogs(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    
    @GET ("/service/platform/communication/v1.0/company/{company_id}/application/{application_id}/log")
    Call<PlatformModels.Logs> getCommunicationLogs(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_id") String pageId , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort , @Query("query") HashMap<String,Object> query );
    ...
    Call<PlatformModels.SmsProviders> getSmsProviders(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.SmsTemplates> getSmsTemplates(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
    ...
    Call<PlatformModels.SystemSmsTemplates> getSystemSystemTemplates(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("sort") HashMap<String,Object> sort );
...
interface PaymentApiList {
    ...
    Call<PlatformModels.SubscriptionPaymentMethodResponse> getSubscriptionPaymentMethod(@Path("company_id") Integer companyId );
...
interface OrderApiList {
    ...
    Call<HashMap<String,Object>> checkRefund(@Path("company_id") String companyId , @Path("shipment_id") String shipmentId );
    ...
    Call<PlatformModels.ShipmentReasonsResponse> getPlatformShipmentReasons(@Path("company_id") String companyId , @Path("application_id") String applicationId );
...
interface CatalogApiList {
    ...
    Call<PlatformModels.TemplatesResponse> listProductTemplate(@Path("company_id") String companyId , @Query("departments") String departments );
    ...
    Call<PlatformModels.ProductListingResponse> getProducts(@Path("company_id") Double companyId , @Query("brand_ids") Double brandIds , @Query("category_ids") Double categoryIds , @Query("search") String search , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize );
    ...
    Call<PlatformModels.Product> getProduct(@Query("item_code") String itemCode , @Path("company_id") Integer companyId , @Path("item_id") Integer itemId , @Query("brand_uid") Integer brandUid , @Query("uid") Integer uid );
    ...
    Call<PlatformModels.ValidateProduct> getProductValidation(@Path("company_id") Double companyId );
    ...
    Call<PlatformModels.ProductTagsViewResponse> getCompanyTags(@Path("company_id") Integer companyId );
    ...
    Call<PlatformModels.InventoryResponse> getInventory(@Path("company_id") String companyId , @Path("item_id") String itemId , @Path("size") String size , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize );
    
    @DELETE ("/service/platform/catalog/v1.0/company/{company_id}/products/{item_id}/sizes/<size>/location/{location_id}/")
    Call<PlatformModels.InventoryDelete> deleteInventory(@Path("company_id") String companyId , @Path("item_id") Integer itemId , @Path("location_id") Double locationId );
    ...
    Call<PlatformModels.SuccessResponse> deleteBulkInventoryJob(@Path("company_id") String companyId );
    
    @POST ("/service/platform/catalog/v1.0/company/{company_id}/inventory/bulk/<batch_id>/")
    Call<PlatformModels.SuccessResponse> createBulkInventory(@Path("company_id") Integer companyId ,@Body PlatformModels.InventoryBulkRequest payload);
...
interface CartApiList {
    ...
    Call<PlatformModels.CartDetail> fetchCartItems(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("cart_items") List<PlatformModels.CartItem> cartItems );
    ...
    Call<PlatformModels.CartDetailsResponseSerializer> checkCartServiceability(@Path("company_id") String companyId , @Path("application_id") String applicationId ,@Body PlatformModels.ServiceablityReqSerializer payload);
    
    @POST ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/cart/checkout")
    Call<HashMap<String,Object>> checkoutCartItems(@Path("company_id") String companyId , @Path("application_id") String applicationId ,@Body PlatformModels.OpenApiCheckoutReq payload);
    
    @POST ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/cart/checkout/confirm")
    Call<HashMap<String,Object>> updateCheckoutPaymentStatus(@Path("company_id") String companyId , @Path("application_id") String applicationId ,@Body PlatformModels.ConfirmPaymentReqSerializer payload);
...
interface WebhookApiList {
    ...
    Call<PlatformModels.SubscriberConfigList> getSubscribersByCompanyAndEventId(@Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Path("company_id") String companyId , @Path("event_id") Integer eventId );
