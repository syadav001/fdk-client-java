...
interface CatalogApiList {
    ...
    Call<PlatformModels.SuccessResponse> upsertAppProductMeta(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("item_id") String  itemId );
