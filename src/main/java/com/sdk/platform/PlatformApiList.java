...
interface CatalogApiList {
    ...
    Call<PlatformModels.StoreAssignResponse> locationReassignment(@Path("company_id") String companyId , @Path("application_id") String applicationId ,@Body PlatformModels.AssignStore payload);
