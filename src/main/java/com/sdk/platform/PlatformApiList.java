...
interface InventoryApiList {
    ...
    Call<PlatformModels.ResponseEnvelopeListJobConfigDTO> getJobConfigByIntegrationType(@Path("company_id")  String companyId , @Query("integration_type") String  integrationType );
