...
interface InventoryApiList {
    ...
    Call<PlatformModels.ResponseEnvelopeJobMetricsDto> getJobCodeMetrics(@Path("company_id")  String companyId , @Path("code") String  code , @Query("page_no") Integer  pageNo , @Query("page_size") Integer  pageSize );
...
interface WebhookApiList {
    ...
    Call<PlatformModels.SubscriberResponse> getSubscribersByExtensionId(@Query("page_no") Integer  pageNo , @Query("page_size") Integer  pageSize , @Path("company_id")  String companyId , @Query("extension_id") String  extensionId );
