...
interface ContentApiList {
    ...
    Call<PlatformModels.PageSchema> createPageV2(@Path("company_id") String companyId , @Path("application_id") String applicationId ,@Body PlatformModels.PageRequest payload);
    
    @GET ("/service/platform/content/v2.0/company/{company_id}/application/{application_id}/pages/")
    Call<PlatformModels.PageGetResponse> getPagesV2(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize );
    
    @PUT ("/service/platform/content/v2.0/company/{company_id}/application/{application_id}/pages/{id}")
    Call<PlatformModels.PageSchema> updatePageV2(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Path("id") String id ,@Body PlatformModels.PageSchema payload);
    
    @GET ("/service/platform/content/v2.0/company/{company_id}/application/{application_id}/pages/{slug}")
    Call<PlatformModels.PageSchema> getPageBySlugV2(@Path("company_id") String companyId , @Path("application_id") String applicationId , @Path("slug") String slug );
