...
interface InventoryApiList {
    ...
    Call<PlatformModels.ResponseEnvelopeListJobStepsDTO> getJobSteps(@Path("company_id") Integer companyId , @Query("job_id") Integer jobId );
    ...
    Call<PlatformModels.ResponseEnvelopeJobMetricsDto> getJobCodeMetrics(@Path("company_id") Integer companyId , @Path("code") String code , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize , @Query("date") String date );
