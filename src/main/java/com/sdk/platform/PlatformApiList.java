...
interface CatalogApiList {
    ...
    Call<PlatformModels.ProductListingResponse> getProducts(@Path("company_id") Double companyId , @Query("brand_ids") List<Double> brandIds , @Query("category_ids") List<Double> categoryIds , @Query("search") String search , @Query("page_no") Integer pageNo , @Query("page_size") Integer pageSize );
