...
interface ContentApiList {
    ...
    Call<List<PlatformModels.DataLoaderResponseSchema>> getDataLoadersByService(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("service_name") String  serviceName );
...
interface PaymentApiList {
    ...
    Call<PlatformModels.OrderBeneficiaryResponse> getUserOrderBeneficiaries(@Query("order_id") String  orderId , @Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    
    @GET ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/refund/accounts/user")
    Call<PlatformModels.OrderBeneficiaryResponse> getUserBeneficiaries(@Query("order_id") String  orderId , @Path("company_id")  String companyId , @Path("application_id")  String applicationId );
...
interface CatalogApiList {
    ...
    Call<PlatformModels.Product> getProduct(@Query("item_code") String  itemCode , @Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Query("brand_uid") Integer  brandUid );
    ...
    Call<PlatformModels.ProductListingResponse> getProductSize(@Query("item_code") String  itemCode , @Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Query("brand_uid") Integer  brandUid , @Query("uid") Integer  uid );
    ...
    Call<PlatformModels.BrandListingResponse> getApplicationBrands(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("department") String  department , @Query("page_no") Integer  pageNo , @Query("page_size") Integer  pageSize , @Query("q") String  q , @Query("uids") Integer  uids );
    ...
    Call<PlatformModels.LocationListSerializer> getLocations(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("store_type") String  storeType , @Query("uid") Integer  uid , @Query("q") String  q , @Query("stage") String  stage , @Query("page_no") Integer  pageNo , @Query("page_size") Integer  pageSize );
...
interface FileStorageApiList {
    ...
    Call<PlatformModels.BulkResponse> copyFiles(@Query("sync") Boolean  sync , @Path("company_id")  String companyId ,@Body PlatformModels.BulkRequest payload);
    
    @POST ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/uploads/copy/")
    Call<PlatformModels.BulkResponse> appCopyFiles(@Query("sync") Boolean  sync , @Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.BulkRequest payload);
...
interface WebhookApiList {
    ...
    Call<PlatformModels.SubscriberResponse> getSubscribersByCompany(@Query("page_no") Integer  pageNo , @Query("page_size") Integer  pageSize , @Path("company_id")  String companyId , @Query("extension_id") String  extensionId );
    ...
    Call<PlatformModels.SubscriberResponse> getSubscribersByExtensionId(@Query("page_no") Integer  pageNo , @Query("page_size") Integer  pageSize , @Path("company_id")  String companyId , @Path("extension_id") String  extensionId );
    ...
    Call<PlatformModels.EventConfigList> fetchAllEventConfigurations(@Path("company_id")  String companyId );
