...
public static class InventoryService {
    ...
    public PlatformModels.ResponseEnvelopeListJobConfigDTO getJobConfigByIntegrationType(String integrationType ) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.ResponseEnvelopeListJobConfigDTO> response = inventoryApiList.getJobConfigByIntegrationType(this.companyId ,integrationType ).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
