...
public static class CompanyProfileService {
    ...
    **/
    ...
    public PlatformModels.LocationListSerializer getLocations(String storeType , String q , String stage , String storeCode , Integer pageNo , Integer pageSize ) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
